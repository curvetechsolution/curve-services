...
// ── Global Styles ─────────────────────────import { useState, useEffect, useMemo } from "react";
      ...
      <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
        ...
        <div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:6 }}>
            {features.map(f => (
              <div key={f.key} style={{ background: (f.type==="toggle"?sel[f.key]:true) ? `${color}08` : "#f8fafc", border:`1.5px solid ${(f.type==="toggle"?sel[f.key]:true)?color+"30":"#e8edf2"}`, borderRadius:10, padding:"7px 10px", transition:"all .2s" }}>
